...
from hitfloor.request.chat_template import file_sha256, render_simple_chat_template
from hitfloor.request.model_resolver import ModelResolver
from hitfloor.request.parser import ParsedRequest
from hitfloor.request.tokenizer import SimpleWhitespaceTokenizer
...
class TokenizerRegistry:
    ...
    def encode(self, request: ParsedRequest) -> TokenizationResult:
